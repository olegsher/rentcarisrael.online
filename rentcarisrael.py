...
@app.route('/')
def index():
    return render_template('index.html', title=title, Albar_my_low_price = Albar_my_low_price_20200115, Albar_branches=Albar_branches, description=description)

@app.route('/ru/')
def index_ru():
    return render_template('index.html', title=title_ru, Albar_my_low_price = Albar_my_low_price_20200115, Albar_branches=Albar_branches, description=description)
