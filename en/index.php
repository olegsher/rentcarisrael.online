...
//    $headers .= "CC: admin@vastama.com\r\n";
    ...
    $subject = $_POST['First_name'] . " " . $_POST['Last_name'] . " " . $_POST['car-select'] . " " . "rentcarisrael.online";    
            ...
            $message .= '<hr />';
            $message .= 'Car Rental in Israel http://www.rentcarisrael.online +972-58-7710101';
            $message .= '<hr />';
$message .= '<img src="http://www.rentcarisrael.online/images/Thrifty-Israel.jpg" alt="Car Rental in Israel +972-58-7710101" />';
...
$message .= "</body></html>";
    ...
    $subject2 = "Car Rental in Israel http://www.rentcarisrael.online +972-58-7710101";
...
<html lang="en">
<head>
<title>Car Rental in Israel | RentCarIsrael.online</title>
<meta name="keywords" content="Car Rental in Israel" />
...
<meta property="og:title" content="Car Rental in Israel" />
<meta property="og:description" content="Car Rental in Israel, Whatsapp/Viber +972-58-7710101"/>
<meta name="yandex-verification" content="0e2c46f9166dab70" />
<meta name="google-site-verification" content="GXy2QWiW2INpdzzbiHF5cvzh7jjaYdmzjlHuF3pYFZk" />
...
<style>        
.top-header{background-color:#3F84B1;border-bottom:0 none;height:36px;line-height:35px;}
